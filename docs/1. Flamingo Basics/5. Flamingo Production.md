...
## Running Flamingo
* Most likely you are running your application behind a Load Balancer like Nginx or a Kubernetes Ingress
...
For ping (readynessProbe) and healthcheck (livenessProbe) endpoints please check out the [Healthcheck module](../3.%20Core%20Modules/Heathcheck.md)