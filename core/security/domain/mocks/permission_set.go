...
// Permissions provides a mock function for the type PermissionSet
func (_mock *PermissionSet) Permissions() []string {
	ret := _mock.Called()
...
func (_c *PermissionSet_Permissions_Call) Return(strings []string) *PermissionSet_Permissions_Call {
