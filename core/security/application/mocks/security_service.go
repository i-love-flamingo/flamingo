...
func (_m *SecurityService) IsGranted(_a0 context.Context, _a1 *sessions.Session, _a2 string, _a3 interface{}) bool {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 bool
	if rf, ok := ret.Get(0).(func(context.Context, *sessions.Session, string, interface{}) bool); ok {
...
func (_m *SecurityService) IsLoggedIn(_a0 context.Context, _a1 *sessions.Session) bool {
...
func (_m *SecurityService) IsLoggedOut(_a0 context.Context, _a1 *sessions.Session) bool {
	ret := _m.Called(_a0, _a1)
