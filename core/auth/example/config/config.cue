...
AuthFake1WithDefaultTemplate :: core.auth.fake & {broker: "fake1WithDefaultTemplate", validatePassword: true, userConfig: {jondoe: {password: "password"}}}
AuthFake1WithCustomTemplate :: core.auth.fake & {broker: "fake1WithCustomTemplate", validatePassword: true, validateOtp: true, usernameFieldId: "customUsernameField", passwordFieldId: "customPasswordField", userConfig: {jondoe: {password: "password"}}, loginTemplate: """
<body>
